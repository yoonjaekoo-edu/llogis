...
exports.loginRateLimit = exports.profileRateLimit = exports.signupRateLimit = void 0;
...
function rateLimit(options) {
    const { windowMs, max, message = '너무 많은 요청입니다. 잠시 후 다시 시도해주세요.', keyGenerator, } = options;
